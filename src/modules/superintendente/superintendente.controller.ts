...
export class SuperintendenteController {
  ...
  getSuperintendenteById (@Param('id') id: string){
    return this.superintendenteService.getSuperintendenteBydId(id)
  }

  @Delete('deleteSuperintendente/:id')
  deleteSuperintendente(@Param('id') id:string ){
    return this.superintendenteService.deleteSuperintendente(id)
  }
}
